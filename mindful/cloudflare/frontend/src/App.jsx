      ...
      <header className="sticky top-0 z-20 backdrop-blur bg-bg/85 border-b border-border">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center gap-3">
          <Link to="/" className="font-bold tracking-tight text-lg flex items-center gap-2">
            <svg viewBox="0 0 32 32" className="w-5 h-5 text-wood" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" strokeLinecap="round" aria-hidden="true">
              <rect x="6"   y="10.5" width="20" height="4" />
              <rect x="5"   y="15.5" width="22" height="4" />
              <rect x="6.5" y="20.5" width="19" height="4" />
            </svg>
            Tsundoku
          </Link>
