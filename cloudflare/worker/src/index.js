...
import { listPosts, getPost, patchPost, sourceCounts, searchPosts, libraryPosts, markReadBulk, clearDomain, heartbeat } from './routes/posts.js';
...
const router = new Router()
  ...
  .get('/api/posts/heartbeat',           heartbeat)
  .post('/api/posts/mark-read-bulk',     markReadBulk)
  .post('/api/posts/clear-domain',       clearDomain)
